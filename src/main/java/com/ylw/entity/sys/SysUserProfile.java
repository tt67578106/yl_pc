...
public class SysUserProfile extends IdEntity implements java.io.Serializable{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "SysUserProfile";
	...
	public boolean equals(Object obj) {
		if(obj instanceof SysUserProfile == false) return false;
		if(this == obj) return true;
		SysUserProfile other = (SysUserProfile)obj;
