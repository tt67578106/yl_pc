 ...
 * 中文姓名生成器
 * @author Nicolas
 * Create Date 2014年4月30日
 */
public class ChineseNameMaker {
	// 姓
	...
	static String[] commonFamilyNames={"李","王","张","刘","陈","杨","赵","黄",
		"周","吴","徐","孙","胡","朱","高","林","何","郭","马","罗","梁","宋","郑","谢"
		,"韩","唐","冯","于","董","萧","程","曹","袁","邓","许","傅","沈","曾","彭","吕"
		,"苏","卢","蒋","蔡","贾","丁","魏","薛","叶","阎","余","潘","杜","戴","夏","钟"
		,"汪","田","任","姜","范","方","石","姚","谭","廖","邹","熊","金","陆","郝","孔"
		,"白","崔","康","毛","邱","秦","江","史","顾","侯","邵","盂","龙","万","段","雷"
		,"钱","汤","尹","黎","易","常","武","乔","贺","赖","龚","文"};

	static String[] familyNames = { "爱新觉罗", "赵", "钱", "孙", "李", "周", "吴", "郑",
			...
			"后", "荆", "红", "游", "竺", "权", "逑", "盖", "益", "桓", "公", "万俟", "司马",
			"上官", "欧阳", "夏侯", "诸葛", "闻人", "东方", "赫连", "皇甫", "尉迟", "公羊", "澹台",
			"公冶", "宗政", "濮阳", "淳于", "单于", "太叔", "申屠", "公孙", "仲孙", "轩辕", "令狐",
			"锺离", "宇文", "长孙", "慕容", "鲜于", "闾丘", "司徒", "司空", "丌官", "司寇", "仉",
			"督", "子车", "颛孙", "端木", "巫马", "公西", "漆雕", "乐正", "壤驷", "公良", "拓拔",
			"夹谷", "宰父", "谷梁", "晋", "楚", "阎", "法", "汝", "鄢", "涂", "钦", "段干",
			"百里", "东郭", "南门", "呼延", "归", "海", "羊舌", "微生", "岳", "帅", "缑", "亢",
			"况", "後", "有", "琴", "梁丘", "左丘", "东门", "西门", "商", "牟", "佘", "佴",
			"伯", "赏", "南宫", "墨", "哈", "谯", "笪", "年", "爱", "阳", "佟" };
	static String[] boyNames = { "绍祖", "继祖", "孝先", "敬先", "成祖", "广嗣", "延嗣",
			"裕孙", "蕃孙", "绍箕", "绍袭", "绳武", "克武", "继业", "显祖", "亮祖", "光祖", "延祖",
			"怀祖", "念祖", "怡祖", "悦祖", "建国", "振国", "兴国", "济世", "柱国", "扶中", "爱民",
			"民子", "泽民", "民生", "公朴", "景贤", "慕圣", "慕东", "希孟", "华东", "希晏", "希圣",
			"希周", "宗尼", "成才", "博学", "勇军", "前进", "连良", "学忠", "宗仁", "学智", "克勤",
			"宗谦", "德良", "尚德", "书诚", "正直", "德福", "德友", "长寿", "长龄", "长生", "长庚",
			"康生", "平安", "彭寿", "延寿", "益寿", "龟龄", "龟寿", "介官", "有官", "太山", "秀才",
			"富贵", "财旺", "有财", "进财", "盛富", "金银", "宝玉", "虎豹", "虎子", "大虎", "二虎",
			"山虎", "山豹", "长空", "天宇", "万里", "江山", "高山", "山峰", "大海", "长河", "刚",
			"正", "直", "真", "钢", "铁", "金", "铜", "银", "石", "山", "木", "虎", "豹",
			"志强", "志坚", "志刚", "铁民", "大力", "如山", "如刚", "千均", "铁柱", "刚强", "劲松",
			"劲草", "浪舟", "海鸥", "旭东", "大春", "石峰", "浩天", "浩然", "石泉", "百坚", "博",
			"木树", "能辉", "敏雄", "龙彬", "锐", "无忌" };
	static String[] girlNames = { "秀秀", "娟娟", "英子", "晓慧", "巧佳", "美丽", "娜娜",
			"静静", "丽丽", "秀", "娟", "英", "华", "慧", "巧", "美", "娜", "静", "淑", "惠",
	...
	public static String generateName() {
		familyName = commonFamilyNames[random.nextInt(98)];
