...
<jsp:include page="/WEB-INF/layouts/enterpriseTop.jsp"></jsp:include>
    ...
    <div class="ent-login-wrapper">
        <div class="box-out">
            <div class="ent-login">
                ...
                <!---->
                    <ul class="title"><li>企业登录</li><li class="current first">企业用户注册</li></ul>
                    <!--登录-->
                    <div class="content-each">
                        ...
                        <div class="input-each code-wrapper"><input type="text" value="请输入验证码" name="valiCode" id="input_valiCode" class="tip-text input-g-2 code" onblur="return cklg()"/><img id="img_login_captcha" /></div>
                    ...
                    <div class="content-each show">
                    	<div class="tips error-g">${register_err_msg}</div>
                    	 <input type="hidden" name="role" value="enterprise"/>
                    	 <form action="${ctx}/register/registerUserPage" method="post" onsubmit="return ckrg()">
                    	<div class="input-each"><input type="text" id="input_reg_loginname" name="loginname" value="请输入用户名" maxlength="50"  class="tip-text input-g-2" onchange="return ckun()"/></div>
                        ...
                        <div class="input-each code-wrapper"><input class="tip-text input-g-2 code" type="text" id="input_reg_vali" name="thekey" value="请输入验证码" style="width:120px;"></input><input type="button" value="发送验证码" id="btn_gain_vali_key" onclick="gainkey()" class="send-btn"/></div>
	...
	<script>
		...
		function ckun() {
			...
			if (/^[a-zA-Z]{1}[a-zA-Z0-9|-|_]{2,14}[a-zA-Z0-9]{1}$/.text(loginname)) {
		...
		function ckrg() {
			...
			if (!/^[a-zA-Z]{1}[a-zA-Z0-9|-|_]{2,14}[a-zA-Z0-9]{1}$/.text(u)) {
				$('.error-g').html("用户名由字母开头，含数字下划线，长度为的4～16位！");
				return false;
