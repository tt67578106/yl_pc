            ...
            <div class="tab-g">
                ...
                <div class="content-each">
                    <div class="list">
                        ...
                        <ul class="each">
                         ...
                         <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">春天集团</li>
                            <li class="post">客服专员</li>
                            <li class="salary">￥2500-3000元/月</li>
                        </ul>
                        </a>
                         <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">哈尔斯真空器皿</li>
                         ...
                         <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">昱能科技</li>
                            <li class="post">销售客服</li>
                            <li class="salary">￥3000-5000元/月</li>
                        </ul>
                        </a>
                         <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">电子科技</li>
                            <li class="post">客服</li>
                ...
                <div class="content-each">
                    <div class="list">
                        ...
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">王力集团</li>
                            <li class="post">营销精英</li>
                            <li class="salary">￥3000-5000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">超人集团</li>
                            <li class="post">区域经理</li>
                            <li class="salary">￥2000-5000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">卡拉扬集团</li>
                            <li class="post">销售代表</li>
