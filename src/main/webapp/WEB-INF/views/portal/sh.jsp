            ...
            <div class="tab-g">
                ...
                <div class="content-each show">
                    <div class="list">
                        ...
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">台积电</li>
                            <li class="post">普工</li>
                            <li class="salary">￥2400-4800元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">中芯国际</li>
                            <li class="post">普工</li>
                        ...
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">富驰高科技</li>
                            <li class="post">操作工</li>
                            <li class="salary">￥4000-5000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">华虹宏力</li>
                            <li class="post">作业员</li>
                            <li class="salary">￥5000-7500元/月</li>
                        </ul>
                        </a>
                        <div class="clear"></div>
                    </div>
                ...
                <div class="content-each">
                    <div class="list">
                        ...
                        <ul class="each">
                         ...
                         <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">广讯集团</li>
                            <li class="post">电话客服</li>
                            <li class="salary">￥3200-6000元/月</li>
                        </ul>
                        </a>
                         <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">大众汽车</li>
                            <li class="post">客服专员</li>
                            <li class="salary">￥3200-5300元/月</li>
                        </ul>
                        </a>
                         <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">电讯盈科</li>
                            <li class="post">客服专员</li>
                            <li class="salary">￥3300-5000元/月</li>
                        </ul>
                        </a>
                         <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">浦发银行</li>
                            <li class="post">客服</li>
                            <li class="salary">￥3000-5000元/月</li>
                        </ul>
                        </a>
                ...
                <div class="content-each">
                    <div class="list">
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">光大银行</li>
                            <li class="post">销售经理</li>
                            <li class="salary">￥4000-10000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">爱回收网</li>
                            <li class="post">门店销售</li>
                            <li class="salary">￥4000-5000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">商派网络科技</li>
                            <li class="post">客户经理</li>
                            <li class="salary">￥6000-8000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">美菜网</li>
                            <li class="post">客户经理</li>
                            <li class="salary">￥4000-15000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">珍岛信息技术</li>
                            <li class="post">销售代表</li>
                            <li class="salary">￥5000-10000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">兰焜信息科技</li>
                            <li class="post">销售</li>
                            <li class="salary">￥4000-15000元/月</li>
                        </ul>
                        </a>
                ...
                <div class="content-each">
                    <div class="list">
                        ...
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">报喜鸟服饰</li>
                            <li class="post">车床工</li>
                            <li class="salary">￥2800-4000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">美蓓亚精密机电</li>
                            <li class="post">模具</li>
