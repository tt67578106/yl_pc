                ...
                <div class="content-each show">
                    <div class="list">
                        ...
                        <ul class="each">
                            ...
                            <li class="salary">￥4000-4500元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">新华昌运输设备</li>
                            <li class="post">操作工</li>
                            <li class="salary">￥3800-5000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">长城精益汽车零部件</li>
                            <li class="post">普工</li>
