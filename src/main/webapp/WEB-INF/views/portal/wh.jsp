            ...
            <div class="tab-g">
                ...
                <div class="content-each">
                    <div class="list">
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">当纳利集团</li>
                            <li class="post">客服专员</li>
                            <li class="salary">￥3500-7000元/月</li>
                        </ul>
                        </a>
                         <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">京北方信息技术</li>
                            <li class="post">客服</li>
                            <li class="salary">￥3000-5000元/月</li>
                        </ul>
                        </a>
                        ...
                        <ul class="each">
                         ...
                         <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">泰康人寿</li>
                            <li class="post">客服</li>
                            <li class="salary">￥3000-4499元/月</li>
                        </ul>
                        </a>
                        <div class="clear"></div>
                    </div>
                ...
                <div class="content-each">
                    <div class="list">
                        ...
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">童学文化</li>
                            <li class="post">市场行销</li>
                            <li class="salary">￥2000-4000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">曙光信息产业</li>
                            <li class="post">销售</li>
                            <li class="salary">￥3000-5000元/月</li>
                        </ul>
                        </a>
                ...
                <div class="content-each">
                    <div class="list">
                        ...
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">国创高科</li>
                            <li class="post">司机</li>
                            <li class="salary">￥2800-5000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">巨人教育</li>
                            <li class="post">司机</li>
                            <li class="salary">￥3000-4000元/月</li>
                        </ul>
                        </a>
                ...
                <div class="content-each">
                    <div class="list">
                        ...
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">泛博制动部件</li>
                            <li class="post">数控车床</li>
                            <li class="salary">￥3200-4000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">耀华安全玻璃</li>
                            <li class="post">钳工</li>
                            <li class="salary">￥3000-5000元/月</li>
                        </ul>
                        </a>
                        ...
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">锦瀚源</li>
                            <li class="post">钣金工</li>
                            <li class="salary">￥3000-5000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">世捷企业管理</li>
                            <li class="post">模具钳工</li>
                            <li class="salary">￥4500-5999元/月</li>
                        </ul>
                        </a>
