            ...
            <div class="tab-g">
                ...
                <div class="content-each show">
                    <div class="list">
                        ...
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">达运精密工业</li>
                            <li class="post">操作工</li>
                            <li class="salary">￥3300-5500元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">金龙联合汽车</li>
                            <li class="post">普工</li>
                        ...
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">天马微电子</li>
                            <li class="post">普工</li>
                            <li class="salary">￥3500-5110元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">联想集团</li>
                            <li class="post">普工</li>
                ...
                <div class="content-each">
                    <div class="list">
                        ...
                        <ul class="each">
                         ...
                         <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">顶尖电子</li>
                            <li class="post">售后客服</li>
                            <li class="salary">￥3000-8000元/月</li>
                        </ul>
                        </a>
                         <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">维多利亚大酒店</li>
                            <li class="post">接线客服</li>
                ...
                <div class="content-each">
                    <div class="list">
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">笨鸟电子商务</li>
                            <li class="post">电话销售</li>
                            <li class="salary">￥6000-8000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">豪盛塑料制品</li>
                        ...
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">中烟工业</li>
                            <li class="post">营销员</li>
                            <li class="salary">￥3000-5000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">伯力爵食品</li>
                ...
                <div class="content-each">
                    <div class="list">
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">麦当劳</li>
                            <li class="post">服务员</li>
                            <li class="salary">￥1500-2500元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">海上花园</li>
                            <li class="post">服务员</li>
                            <li class="salary">￥2500-5000元/月</li>
                        </ul>
                        </a>
                ...
                <div class="content-each">
                    <div class="list">
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">鑫华宝硅橡胶</li>
                            <li class="post">钳工</li>
                            <li class="salary">￥5000-6000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">创业人环保科技</li>
                            <li class="post">车工</li>
                            <li class="salary">￥3000-5000元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">汇德环保纸袋</li>
                            <li class="post">车床工</li>
                            <li class="salary">￥4500-5500元/月</li>
                        </ul>
                        </a>
                        <a href="javascript:;" target="_blank">
                        <ul class="each">
                            <li class="company">佳力卫厨</li>
                            <li class="post">模具</li>
